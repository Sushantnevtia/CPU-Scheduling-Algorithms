...
> Check the attached [testcases](https://github.com/Sushantnevtia/CPU-Scheduling-Algorithms/tree/main/testcases) for more details.


## Contributors

- [Sushant Nevtia](https://github.com/Sushantnevtia)
